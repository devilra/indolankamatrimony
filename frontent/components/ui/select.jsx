...
function SelectLabel({ className, ...props }) {
  return (
    <SelectPrimitive.Label
      ...
      className={cn(
        "text-muted-foreground px-2 py-1.5 placeholder:text-black placeholder:font-bold text-xs",
        className
      )}
      {...props}
    />
